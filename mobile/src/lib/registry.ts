...
import { EDIT_TOKENS_STORAGE_KEY } from './storage';

const API_URL = import.meta.env.VITE_API_URL ?? 'https://api.remembered8.com';
...
export class RegistryRequestError extends Error {
  // Written out rather than a parameter property: the mobile bundle compiles
  // with erasableSyntaxOnly, which forbids that shorthand.
